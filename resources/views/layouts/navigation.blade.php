<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('scalping-bots.index')" :active="request()->routeIs('scalping-bots.*')">
                        {{ __('Scalping Bots') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('trading-bots.index')">
                        ...
                        <x-dropdown-link :href="route('scalping-bots.index')">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                            </svg>
                            {{ __('Scalping Bots') }}
                        ...
                        <x-dropdown-link :href="route('assets.portfolio')">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('trading-bots.index')" :active="request()->routeIs('trading-bots.*')">
                {{ __('Spot Bots') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('futures-bots.index')" :active="request()->routeIs('futures-bots.*')">
                {{ __('Futures Bots') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('scalping-bots.index')" :active="request()->routeIs('scalping-bots.*')">
                {{ __('Scalping Bots') }}
            </x-responsive-nav-link>
