                    ...
                    <div class="p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-lg font-semibold text-gray-900">{{ $signals->where('executed', true)->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-500">Long Signals</p>
                                <p class="text-lg font-semibold text-gray-900">{{ $signals->where('direction', 'long')->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-500">Short Signals</p>
                                <p class="text-lg font-semibold text-gray-900">{{ $signals->where('direction', 'short')->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-500">Avg Strength</p>
                                <p class="text-lg font-semibold text-gray-900">{{ number_format($signals->avg('strength') * 100, 1) }}%</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Risk/Reward</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($signals as $signal)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900">{{ $signal->signal_type }}</td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900">
                                                <div class="flex items-center">
                                                    <div class="w-16 bg-gray-200 rounded-full h-2 mr-2">
                                                        <div class="bg-blue-600 h-2 rounded-full" style="width: {{ $signal->strength * 100 }}%"></div>
                                                    </div>
                                                    <span class="text-xs">{{ number_format($signal->strength * 100, 1) }}%</span>
                                                </div>
                                            </td>
                            ...
                            @foreach($signals as $signal)
                                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex justify-between">
                                            <span class="text-sm text-gray-500">Risk/Reward:</span>
                                            <span class="text-sm font-medium">{{ number_format($signal->risk_reward_ratio, 2) }}:1</span>
                                        </div>
                                        @endif
