        ...
        @endif
            ...
            <form method="POST" action="{{ route('futures-bots.store') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="symbol" id="symbol" value="{{ old('symbol') }}" placeholder="BTCUSDT" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            @error('symbol')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select name="leverage" id="leverage" required
                                ...
                                @foreach($leverages as $leverage)
                                    <option value="{{ $leverage }}" {{ old('leverage') == $leverage ? 'selected' : '' }}>
                                        {{ $leverage }}x
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select name="margin_type" id="margin_type" required
                                ...
                                @foreach($marginTypes as $marginType)
                                    <option value="{{ $marginType }}" {{ old('margin_type') == $marginType ? 'selected' : '' }}>
                                        {{ ucfirst($marginType) }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select name="position_side" id="position_side" required
                                ...
                                @foreach($positionSides as $positionSide)
                                    <option value="{{ $positionSide }}" {{ old('position_side') == $positionSide ? 'selected' : '' }}>
                ...
                <div class="mt-8 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="number" name="risk_percentage" id="risk_percentage" value="{{ old('risk_percentage', 1) }}" 
                        ...
                        <div>
                            ...
                            <input type="number" name="max_position_size" id="max_position_size" value="{{ old('max_position_size', 0.01) }}" 
                        ...
                        <div>
                            ...
                            <input type="number" name="stop_loss_percentage" id="stop_loss_percentage" value="{{ old('stop_loss_percentage', 2) }}" 
                                step="0.1" min="0.1" max="10" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="take_profit_percentage" id="take_profit_percentage" value="{{ old('take_profit_percentage', 4) }}" 
                ...
                <div class="mt-8 flex justify-end space-x-4">
                    <a href="{{ route('futures-bots.index') }}" 
