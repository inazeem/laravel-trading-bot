...
echo "=== FIXING BOT - CLOSING EXISTING TRADES ===\n";
...
foreach ($openTrades as $trade) {
    ...
    $trade->update([
        'status' => 'closed',
        'exit_price' => 3.7256, // Current price
        'closed_at' => now(),
        'realized_pnl' => 0,
        'pnl_percentage' => 0
    ]);
    
    echo "Trade {$trade->id} marked as closed in database\n";
}

// Clear any cooldown periods
