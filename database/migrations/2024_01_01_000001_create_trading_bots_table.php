...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('trading_bots', function (Blueprint $table) {
            ...
            $table->decimal('risk_percentage', 5, 2)->default(2.00); // 2% risk per trade
            $table->decimal('max_position_size', 15, 8)->default(1000.00);
            $table->json('timeframes')->default('["1h", "4h", "1d"]');
